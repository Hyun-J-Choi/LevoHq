...
import ClientRiskPanel from "@/components/dashboard/ClientRiskPanel";
import PredictiveRevenuePanel from "@/components/dashboard/PredictiveRevenuePanel";
import {
  ...
  return (
    <div className="space-y-8">
      ...
      <Suspense fallback={<DashboardPanelSkeleton />}>
        <PredictiveRevenuePanel businessId={businessId} />
      </Suspense>

      <Suspense fallback={<DashboardPanelSkeleton />}>
        <ClientRiskPanel businessId={businessId} />
      </Suspense>
