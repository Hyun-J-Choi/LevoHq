...
function cannedFollowUp(firstName: string, service: string) {
  return `Hi ${firstName}, we hope you are feeling great after your ${service}. We wanted to check in and see how your skin is doing today. Reply here if you want any aftercare tips from our team.`;
}
...
export default async function FollowUpPage() {
  ...
  // Suggestions are pre-generated by the followup cron. No LLM on render.
  const enriched = rows.map((row) => ({
    ...row,
    message:
      row.suggested_followup_message ??
      cannedFollowUp(row.client_name.split(" ")[0] ?? "there", row.service),
  }));
